...
The accepted CLI/backend implementation-facing baseline is `redesign/component-design.md`, `redesign/verification-design.md`, `redesign/test-design.md` and `redesign/implementation-design.md`. The optional user-facing frontend baseline is `application/user-journeys.md`, `application/frontend-application-contracts.md`, `interface/human-interface-design.md`, `interface/frontend-presentation-system.yaml`, `interface/frontend-screen-view-design.yaml`, `architecture/frontend-security.md`, `architecture/frontend-architecture.md`, `redesign/frontend-component-design.md`, `redesign/frontend-verification-design.md`, `redesign/frontend-test-design.md` and `redesign/frontend-implementation-design.md`. Existing implementation code is not design evidence.
