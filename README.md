...
Repository for the **Nutrition Management** product.

This repository treats product knowledge as versioned project assets. Requirements, domain semantics, architecture decisions and execution state are captured in the repository rather than left in chat history.
